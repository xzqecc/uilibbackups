...
function library.Window(self, info, theme)
    ...
    function window.Keybinds(self)
        ...
        local window.kblist = {visible = false, instances = {}}
        ...
        function window.kblist.Update(self)
            local kbds_string = ""
            local max_len = 56
        ...
        function window.kblist.AdjustFuckingUselessShitNamedPositionIWantToDie(self, pos)
            kblist_frame.Position = pos
        end

        function window.kblist.ShowHideFromMyLifePleaseSomebodyKillMeIDontWantToBeAliveRightNowImUselessInMyLife(self, visible)
            for i, v in pairs(self.instances) do
                v.Visible = visible
            end
        end
        ...
        window.kblist:Update()
        window.kblist:AdjustFuckingUselessShitNamedPositionIWantToDie(v2new(20, math.floor(utility:ScreenSize().Y/2)))
        window.kblist:ShowHideFromMyLifePleaseSomebodyKillMeIDontWantToBeAliveRightNowImUselessInMyLife(false)
